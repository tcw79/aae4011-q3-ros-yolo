...
if(aae4011_pcd_extractor_CONFIG_INCLUDED)
  return()
endif()
set(aae4011_pcd_extractor_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(aae4011_pcd_extractor_SOURCE_PREFIX /home/user/catkin_ws/src/AAE4011-S22526-main/ros_package/aae4011_pcd_extractor)
  set(aae4011_pcd_extractor_DEVEL_PREFIX /home/user/catkin_ws/devel)
  set(aae4011_pcd_extractor_INSTALL_PREFIX "")
  set(aae4011_pcd_extractor_PREFIX ${aae4011_pcd_extractor_DEVEL_PREFIX})
else()
  set(aae4011_pcd_extractor_SOURCE_PREFIX "")
  set(aae4011_pcd_extractor_DEVEL_PREFIX "")
  set(aae4011_pcd_extractor_INSTALL_PREFIX /home/user/catkin_ws/install)
  set(aae4011_pcd_extractor_PREFIX ${aae4011_pcd_extractor_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'aae4011_pcd_extractor' is deprecated")
...
set(aae4011_pcd_extractor_FOUND_CATKIN_PROJECT TRUE)
...
if(NOT "/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu " STREQUAL " ")
  set(aae4011_pcd_extractor_INCLUDE_DIRS "")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'AAE4011 Teaching Team <wenwsrobo@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${aae4011_pcd_extractor_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'aae4011_pcd_extractor' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'aae4011_pcd_extractor' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/user/catkin_ws/src/AAE4011-S22526-main/ros_package/aae4011_pcd_extractor/${idir}'.  ${_report}")
    endif()
    _list_append_unique(aae4011_pcd_extractor_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND aae4011_pcd_extractor_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND aae4011_pcd_extractor_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT aae4011_pcd_extractor_NUM_DUMMY_TARGETS)
      set(aae4011_pcd_extractor_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::aae4011_pcd_extractor::wrapped-linker-option${aae4011_pcd_extractor_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR aae4011_pcd_extractor_NUM_DUMMY_TARGETS "${aae4011_pcd_extractor_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::aae4011_pcd_extractor::wrapped-linker-option${aae4011_pcd_extractor_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND aae4011_pcd_extractor_LIBRARIES "${interface_target_name}")
  elseif(${library} MATCHES "^\\$<")
    list(APPEND aae4011_pcd_extractor_LIBRARIES ${library})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(aae4011_pcd_extractor_LIBRARY_DIRS ${lib_path})
      list(APPEND aae4011_pcd_extractor_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'aae4011_pcd_extractor'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND aae4011_pcd_extractor_LIBRARIES ${lib})
    endif()
  endif()
...
set(aae4011_pcd_extractor_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${aae4011_pcd_extractor_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 aae4011_pcd_extractor_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${aae4011_pcd_extractor_dep}_FOUND)
      find_package(${aae4011_pcd_extractor_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${aae4011_pcd_extractor_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(aae4011_pcd_extractor_INCLUDE_DIRS ${${aae4011_pcd_extractor_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(aae4011_pcd_extractor_LIBRARIES ${aae4011_pcd_extractor_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${aae4011_pcd_extractor_dep}_LIBRARIES})
  _list_append_deduplicate(aae4011_pcd_extractor_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(aae4011_pcd_extractor_LIBRARIES ${aae4011_pcd_extractor_LIBRARIES})

  _list_append_unique(aae4011_pcd_extractor_LIBRARY_DIRS ${${aae4011_pcd_extractor_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(aae4011_pcd_extractor_EXPORTED_TARGETS ${${aae4011_pcd_extractor_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${aae4011_pcd_extractor_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
